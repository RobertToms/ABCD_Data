...
# import data
parent <- read_csv(paste0(derivative_data, 'Parent_PrePost_Menarche_11_17_25.csv'))
youth <- read_csv(paste0(derivative_data, 'Youth_PrePost_Menarche_11_17_25.csv'))
...
# Parent: 4924 subjects with Pre/Post Menarche Timepoints
# Youth: 4828 subjects with Pre/Post Menarche Timepoints
...
table(p_counter$has_changescore) # 4921

y_counter <- youth_ples %>%
  mutate(has_changescore = !is.na(ChangeScore))
table(y_counter$has_changescore) # 4827
