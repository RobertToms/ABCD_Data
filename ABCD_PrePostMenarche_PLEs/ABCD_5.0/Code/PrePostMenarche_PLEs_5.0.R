...
y_counter <- youth_ples %>%
  mutate(has_changescore = !is.na(ChangeScore))
table(y_counter$has_changescore) # 3829
...
write_csv(parent_ples_dates, paste0(derivative_data, 'Parent_PrePost_PLEs_12_2_25.csv'))
write_csv(youth_ples_dates, paste0(derivative_data, 'Youth_PrePost_PLEs_12_2_25.csv'))
