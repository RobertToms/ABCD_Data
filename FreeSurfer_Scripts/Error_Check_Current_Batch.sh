##########################################################################
# Error_Check_Current_Batch.sh
# Author: Robert Toms
# Date: 1/12/2025
# Path: ~/dammi/Sandbox/Error_Check_Current_Batch.sh
##########################################################################

# This Script checks to see which subjects in a provided FreeSurfer batch have errored out, and prints whether they errored during segmentation or before.


# Set Subjects Directory to where all derivative data is located
SUBJECTS_DIR=~/dammi/Sandbox/ReRun_Check
#SUBJECTS_DIR=~/dammi/Sandbox/BIDS_Sorted
